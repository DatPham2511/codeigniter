					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="<?php echo base_url('history-order/list')?>"><i class="fa fa-star"></i> Lịch sử mua hàng</a></li>
				...
				<div class="row">
					...
					<div class="col-sm-5">
						<div class="search_box pull-right">
							...
							<input style="margin:0;color:#fff;" type="submit" value="Tìm kiếm" class="btn btn-primary">
							</form>
						</div>
					</div>
				</div>
