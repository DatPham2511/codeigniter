...
class CategoryController extends CI_Controller {
	...
	{
		$this->form_validation->set_rules('title', 'Title', 'trim|required',['required'=>'Bạn phải điền tên danh mục']);
	...
	public function edit($id)
	{
		...
		$this->load->model('CategoryModel');
		$data['cate']=$this->CategoryModel->selectcatebyid($id);
	...
	{
		$this->form_validation->set_rules('title', 'Title', 'trim|required',['required'=>'Bạn phải điền tên']);
		$this->form_validation->set_rules('slug', 'Slug', 'trim|required',['required'=>'Bạn phải điền slug']);
		$this->form_validation->set_rules('description', 'Description', 'trim|required',['required'=>'Bạn phải điền mô tả']);
		if ($this->form_validation->run()==TRUE)
        {
	...
	{
		$this->load->model('CategoryModel');
		$data['category']=$this->CategoryModel->deletecategory($id);
